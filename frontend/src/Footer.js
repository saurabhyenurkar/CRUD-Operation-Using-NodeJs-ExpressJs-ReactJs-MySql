...
const Footer = () => {
  return (
    <div className="fixed-bottom  container">
      <footer className="d-flex flex-wrap justify-content-between align-items-center my-1 border-top">
        ...
        <ul className="sss nav col-md- justify-content-end list-unstyled d-flex">
          <li className="ms-4">
